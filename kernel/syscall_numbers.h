...
/*
 * Syscall number table — ArmoniOS ABI.
 *
 * The numbers in this file are FROZEN. Each one has a matching entry in
 * docs/SYSCALLS.md under "Implemented Now". Any change must update both this
 * file and docs/SYSCALLS.md in the same commit, and must add a comment that
...
_Static_assert(SYS_SPAWN_ARGV == 8ULL, "ABI drift: SYS_SPAWN_ARGV — see docs/SYSCALLS.md");
...
_Static_assert(SYS_READDIR == 46ULL, "ABI drift: SYS_READDIR — see docs/SYSCALLS.md");

#define SYS_UNLINK             47ULL
_Static_assert(SYS_UNLINK == 47ULL, "ABI drift: SYS_UNLINK — see docs/SYSCALLS.md");

#define SYS_RENAME             48ULL
_Static_assert(SYS_RENAME == 48ULL, "ABI drift: SYS_RENAME — see docs/SYSCALLS.md");

#define SYS_IPC_SEND           60ULL
_Static_assert(SYS_IPC_SEND == 60ULL, "ABI drift: SYS_IPC_SEND — see docs/SYSCALLS.md");

#define SYS_IPC_RECV           61ULL
_Static_assert(SYS_IPC_RECV == 61ULL, "ABI drift: SYS_IPC_RECV — see docs/SYSCALLS.md");
...
_Static_assert(SYS_TIMEINFO == 100ULL, "ABI drift: SYS_TIMEINFO — see docs/SYSCALLS.md");

#define SYS_MEMINFO            101ULL
_Static_assert(SYS_MEMINFO == 101ULL, "ABI drift: SYS_MEMINFO — see docs/SYSCALLS.md");

#define SYS_PROCLIST           102ULL
_Static_assert(SYS_PROCLIST == 102ULL, "ABI drift: SYS_PROCLIST — see docs/SYSCALLS.md");
 ...
 * docs/SYSCALLS.md in the same commit.
 */
