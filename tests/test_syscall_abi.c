...
void test_syscall_abi_error_codes_match_documented_constants(void) {
    TEST_ASSERT_EQUAL_INT64(-2, ARMONIOS_ERR_NOMEM);
    TEST_ASSERT_EQUAL_INT64(-3, ARMONIOS_ERR_NOENT);
    TEST_ASSERT_EQUAL_INT64(-5, ARMONIOS_ERR_BADF);
    TEST_ASSERT_EQUAL_INT64(-7, ARMONIOS_ERR_INVAL);
    TEST_ASSERT_EQUAL_INT64(-11, ARMONIOS_ERR_AGAIN);
    TEST_ASSERT_EQUAL_INT64(-13, ARMONIOS_ERR_PERM);
