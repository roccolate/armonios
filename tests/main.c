...
int main(void) {
    ...
    RUN_TEST(test_user_image_load_vfs_flat_uses_mounted_file);
    ...
    RUN_TEST(test_user_image_load_vfs_flat_rejects_missing_or_oversized_file);
    ...
    RUN_TEST(test_gui_left_click_on_background_keeps_focus);
