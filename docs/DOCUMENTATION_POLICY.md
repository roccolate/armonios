...
6. Issue comments and external review notes — context only; they are not current status unless promoted into `CURRENT_STATE.md`.
...
| `CI-VERIFIED` | A hosted CI run completed the stated command and preserved enough logs or artifacts to audit the result. |
