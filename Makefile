...
LIBKARM_ARENA_OBJ := $(BUILD_DIR)/$(LIBKARM_DIR)/arena.o
LIBKARM_ARENA_MAP_OBJ := $(BUILD_DIR)/$(LIBKARM_DIR)/arena_map.o
LIBKARM_BUFFER_OBJ := $(BUILD_DIR)/$(LIBKARM_DIR)/buffer.o
LIBKARM_FILE_OBJ := $(BUILD_DIR)/$(LIBKARM_DIR)/file.o
LIBKARM_ARCHIVE_OBJS := \
    $(LIBKARM_SYSCALL_OBJ) \
    $(LIBKARM_IO_OBJ) \
    $(LIBKARM_STRING_OBJ) \
    $(LIBKARM_ARENA_OBJ) \
    $(LIBKARM_ARENA_MAP_OBJ) \
    $(LIBKARM_BUFFER_OBJ) \
    $(LIBKARM_FILE_OBJ)
